...
-export(['_unsafeCodePointAt0'/1, '_codePointAt'/6, '_countPrefix'/0, '_fromCodePointArray'/0, '_singleton'/1, '_take'/1, '_toCodePointArray'/1]).
...
'_fromCodePointArray'() -> error("unimplemented").
